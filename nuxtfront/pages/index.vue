              ...
              <div class="col-md-6">
                <div class="post-entry-2 d-flex bg-light">
                  <div
                    ...
                    :style="{
                      'background-image':
                        'url(' + require('@/assets/images/img_v_1.jpg') + ')',
                    }"
                  ></div>
                  <div class="contents">
                    <h2>
                ...
                <div class="post-entry-2 d-flex">
                  <div
                    ...
                    :style="{
                      'background-image':
                        'url(' + require('@/assets/images/img_v_2.jpg') + ')',
                    }"
                  ></div>
                  <div class="contents">
                    <h2>
                ...
                <div class="post-entry-2 d-flex">
                  <div
                    ...
                    :style="{
                      'background-image':
                        'url(' + require('@/assets/images/img_v_3.jpg') + ')',
                    }"
                  ></div>
                  <div class="contents">
                    <h2>
      ...
      <div class="container">
        <div class="half-post-entry d-block d-lg-flex bg-light">
          <div
            ...
            :style="{
              'background-image':
                'url(' + require('@/assets/images/big_img_1.jpg') + ')',
            }"
          ></div>
          <div class="contents">
            <span class="caption">Editor's Pick</span>
          ...
          <div class="col-lg-9">
            ...
            <div class="post-entry-2 d-flex">
              <div
                ...
                :style="{
                  'background-image':
                    'url(' + require('@/assets/images/img_h_4.jpg') + ')',
                }"
              ></div>
            ...
            <div class="post-entry-2 d-flex">
              <div
                ...
                :style="{
                  'background-image':
                    'url(' + require('@/assets/images/img_h_3.jpg') + ')',
                }"
              ></div>
              <div class="contents order-md-1 pl-0">
                <h2>
